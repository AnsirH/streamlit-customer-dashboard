...
| 팀원 사진 | 이름 | 역할 |
|-----------|------|------|
| <img src="images/김도윤.jpg" width="120"/> | **김도윤** | 프로젝트 리더, 모델링 및 하이퍼파라미터 튜닝 담당 |
| <img src="images/윤권.jpg" width="120"/> | **윤권** | 데이터 전처리 및 EDA 시각화 담당 |
| <img src="images/이정민.jpg" width="120"/> | **이정민** | Streamlit 대시보드 UI/UX 설계 및 구현 |
| <img src="images/이준석.jpg" width="120"/> | **이준석** | 데이터 수집 및 모델 성능 분석 담당 |
| <img src="images/허한결.jpg" width="120"/> | **허한결** | 보고서 작성 및 발표 자료 제작 담당 |
